---
name: product-upsell
description: Use when mapping a Prudential product to an article for soft upsell, calculating UP (uang pertanggungan), or checking insurance-content compliance before publishing. Covers Opsi A framing, the confirmed UP formula, and mandatory disclaimers.
---
